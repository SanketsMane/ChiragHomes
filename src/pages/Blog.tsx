...
const blogPosts = [
  ...
  {
    id: 2,
    title: 'Bangalore\'s Emerging Neighborhoods to Watch',
    excerpt: 'Explore up-and-coming areas in Bangalore that offer great potential for homebuyers and investors.',
    content: 'Bangalore continues to evolve as India\'s tech capital...',
    author: 'Priya Sharma',
    publishDate: '2024-01-12',
    readTime: '6 min read',
    category: 'Location Guide',
    tags: ['Bangalore', 'Neighborhoods', 'Market Analysis'],
