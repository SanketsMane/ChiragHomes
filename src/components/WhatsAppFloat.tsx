...
export function WhatsAppFloat() {
  const phoneNumber = '919740207010';
  const message = 'Hello%20ChiragHomes%20Team!%20I%20need%20assistance%20with%20property%20search.';
    ...
    <div className="fixed bottom-6 right-6 sm:bottom-8 sm:right-8 z-50">
      ...
      <div className="relative group">
        ...
        <button
          ...
          className="relative overflow-hidden bg-gradient-to-br from-green-500 via-green-600 to-emerald-600 hover:from-green-400 hover:via-green-500 hover:to-emerald-500 text-white p-3 sm:p-3.5 rounded-full shadow-2xl hover:shadow-green-500/30 transition-all duration-500 transform hover:scale-110 focus:outline-none focus:ring-4 focus:ring-green-400/50 active:scale-95 border border-green-400/20"
        >
          {/* Shine Effect */}
